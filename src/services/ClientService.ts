...
export class ClientService {
  ...
  static async updateClient(client: ClientInterface) {
    await fetch(`http://localhost:3000/clients/edit-client/${client._id}`, {
      method: "PUT",
      headers: {
  ...
  static async deleteClient(_id: string) {
    await fetch(`http://localhost:3000/clients/delete-client/${_id}`, {
      method: "DELETE",
    });
  }
}
